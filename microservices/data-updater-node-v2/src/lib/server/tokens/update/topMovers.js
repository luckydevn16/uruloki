...
exports.updateTopMovers = void 0;
...
function updateTopMovers(MINIMUM_TX_COUNT, bitqueryData) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        //Filter out all tokens with less transactions thatn MINIMUM_TX_COUNT, to filter out low quality tokens
        let topMovers = bitqueryData === null || bitqueryData === void 0 ? void 0 : bitqueryData.filter(a => a.count > MINIMUM_TX_COUNT);
        //Preliminary calculation of percent change using "wrong" price
        topMovers = topMovers === null || topMovers === void 0 ? void 0 : topMovers.map(item => {
        ...
        topMovers = topMovers === null || topMovers === void 0 ? void 0 : topMovers.sort((a, b) => { var _a, _b; return Math.abs(((_a = b === null || b === void 0 ? void 0 : b.percentChange) !== null && _a !== void 0 ? _a : 0) - ((_b = a === null || a === void 0 ? void 0 : a.percentChange) !== null && _b !== void 0 ? _b : 0)); });
        //Trim down to top 100 tokens
        topMovers = topMovers.slice(0, 100);
        //Calculate actual price
        let finalList = yield (0, getPriceData_1.getPriceData)(topMovers);
        finalList = finalList.sort((a, b) => { var _a, _b; return Math.abs(((_a = b.percentChange) !== null && _a !== void 0 ? _a : 0) - ((_b = a.percentChange) !== null && _b !== void 0 ? _b : 0)); });
        ...
        yield prisma.top_movers.deleteMany({});
        ...
        tokenCacheTokens.forEach((item, index) => __awaiter(this, void 0, void 0, function* () {
            yield prisma.top_movers.create({
                data: {
                    rank: index + 1,
...
exports.updateTopMovers = updateTopMovers;
